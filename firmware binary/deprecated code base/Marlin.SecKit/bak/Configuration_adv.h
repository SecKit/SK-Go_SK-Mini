...
// ernie added for skr v1.3 + tmc driver.
// see https://github.com/MarlinFirmware/Marlin/issues/12983
 ...
 */
  ...
  #if AXIS_IS_TMC(Y)
    #ifdef BOWDEN_EXTRUSION
    #define Y_CURRENT     700  // (mA) RMS current. Multiply by 1.414 for peak current.
    #else
